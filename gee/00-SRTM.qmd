...
- *Elevation*: Suitable elevations are between 100 and 1,500 meters to avoid valleys and ensure good sunlight exposure.
- *Slope*: Prefer gentle slopes of 5-10% (around 3-6 degrees), although steeper slopes can be used with higher installation costs.
- *Aspect*: In the Northern Hemisphere, aim for south-facing slopes (between 135° and 225°); in the Southern Hemisphere, aim for north-facing slopes (between 315° and 45°).

**Wind Turbines**:

- *Elevation*: Preferably above 500 meters to take advantage of higher wind speeds.
- *Slope*: Ideal slope is less than 5% (around 3 degrees) to ensure stability and ease of construction.
- *Aspect*: Generally not a major concern, as wind turbines are more affected by local wind patterns than the slope's orientation.
...
What is [aspect](https://en.wikipedia.org/wiki/Aspect_(geography))?
